...
export default function Home() {
  return (
    <main className="grid grid-cols-1 grid-rows-2 lg:grid-cols-2 lg:grid-rows-1 w-screen min-h-screen p-5">
      <div className="row-span-1 col-span-1 flex flex-col items-center justify-center">
        ...
        <p className="text-xs relative z-20 md:text-sm lg:text-xl font-bold text-center">
          Helping community college students find real career and transfer
          advice
        </p>
      </div>
      <div className="row-span-1 col-span-1 flex flex-col items-center justify-center">
